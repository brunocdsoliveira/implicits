...
\begin{minipage}[t]{\textwidth}
The proofs of this section regard stability of the deterministic resolution judgment and
stability of the typing judgment of \name. The first part, similarly to
Section~\ref{proof:determinism}, is split into subproofs for each sub-judgment (focusing,
lookup and matching) of the deterministic resolution judgment and follows their dependencies.
The second part uses the main result of the first part to establish stability of typing under
type application reduction. %, as stated in
%Lemma~\ref{lem:stability_tapp_red} of the paper.
