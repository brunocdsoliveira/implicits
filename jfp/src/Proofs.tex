...
%$\bar{\alpha},\alpha,\bar{\alpha}';\tenv,\alpha,\tenv'\ivturns \rulet_1 \iarrow \rulet_2 \leadsto \lambda\relation{x}{|\rulet_1|}.E$ \ \\
%===============================================================================
...
%$\bar{\alpha},\alpha,\bar{\alpha}';\tenv,\alpha,\tenv'\ivturns \forall\beta.\rulet \leadsto \Lambda\beta.E$ \ \\
%===============================================================================
...
%===============================================================================
\klara{Do I need to first clarify that $\alpha \neq \alpha'$? YES!}\\
...
(Lemma~\ref{lemma:unamb_subst:1}). That Lemma is used to prove the case of \rref{UA-Main},
...
\end{equation*}
  and
\begin{equation*}
  \unambig{\bar{\alpha},\alpha,\bar{\alpha}'}{\rulet}
\end{equation*}
  then
\begin{equation*}
  \unambig{\bar{\alpha},\bar{\alpha}'}{\rulet[\suty/\alpha]}
\end{equation*}
\end{lemma}
\end{minipage}
}
...
%===============================================================================
\item[\fbox{\rref{UA-Simp}}]\quad$\unambig{\bar{\alpha},\alpha,\bar{\alpha}'}{\tau}$\\
%===============================================================================
From the first two hypotheses of the theorem, we know that
\begin{equation*}
\ftv{\suty}\subseteq\ftv{\tau}\quad\text{and}\quad\alpha\notin\ftv{\suty}
\end{equation*}
Using these two facts, we get
\begin{equation*}
\arraycolsep=1.4pt\def\arraystretch{1}
\begin{array}{rl}
\ftv{\tau[\suty/\alpha]} &= \left( \ftv{\tau}\setminus\{\alpha\} \right) \cup\ftv{\suty}\\
                         &= \ftv{\tau}\setminus\{\alpha\}
\end{array}
\end{equation*}

The assumption of rule \rref{UA-Simp} is
\begin{equation*}
\bar{\alpha},\alpha,\bar{\alpha}'\subseteq\ftv{\tau}
\end{equation*}
Hence,
\begin{equation*}
\bar{\alpha},\bar{\alpha}'\subseteq\ftv{\tau}\setminus\{\alpha\} = \ftv{\tau[\suty/\alpha]}
\end{equation*}
Using this to instantiate rule \rref{UA-Simp}, we reach the goal:
\begin{equation*}
\unambig{\bar{\alpha},\bar{\alpha}'}{\tau[\suty/\alpha]}
\end{equation*}

%===============================================================================
\item[\fbox{\rref{UA-TAbs}}]\quad$\unambig{\bar{\alpha},\alpha,\bar{\alpha}'}{\tall{\beta}{\rulet}}$\\
%===============================================================================
From the assumption of the rule and the induction hypothesis, we get
\begin{equation*}
\unambig{\bar{\alpha},\bar{\alpha}',\beta}{\rulet[\suty/\alpha]}
\end{equation*}
By using this in rule \rref{UA-TAbs} and from the definition of substitution, we reach the goal:
\begin{equation*}
\unambig{\bar{\alpha},\bar{\alpha}'}{(\tall{\beta}{\rulet})[\suty/\alpha]}
\end{equation*}
