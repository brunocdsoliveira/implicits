...
\begin{proof}
The proof proceeds by induction on the derivation of the hypothesis. Each case follows
from the isomorphism between the rule sets of the two judgements and from
Lemma~\ref{lemma:asoundness:2}.
\end{proof}
