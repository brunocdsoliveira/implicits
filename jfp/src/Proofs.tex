...
\begin{lemma}[Substitution]\label{lemma:substitution}
  If 
\begin{equation*}
  \ares{\tenv, \rulet \leadsto x, \tenv'}{\rulet'}{E'}
...
then
\begin{equation*}
  \ares{\tenv, \bar{\rulet} \leadsto \bar{x}}{\type}{E'}
...
\begin{proof}
See file CochisDet.v, Lemma \texttt{DRes\_match\_impl\_vars}.
\end{proof}
