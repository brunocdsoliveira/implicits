...
%===============================================================================
  ...
  \in |\tenv|$. Finally, by means of rule \mylabel{F-WF-VarTy}, and taking into account
...
%===============================================================================
\item[\fbox{\texttt{(WF-UnivTy)}}\quad$\tenv \turns \forall\alpha.\rulet$] \ \\
%===============================================================================
...
\end{equation*}
  ...
  Hence, by rule \mylabel{F-WF-UnivTy}, and taking into account that
...
\begin{description}
%===============================================================================
\item[\fbox{\texttt{(AR-TAbs)}}\quad$\tenv \vturns \forall \alpha.\rulet \leadsto \Lambda \alpha.E$] \ \\
%===============================================================================
...
%===============================================================================
\item[\fbox{\texttt{(AR-TApp)}}]\quad$\tenv \vturns \rulet [\suty/\alpha] \leadsto E\,|\suty|$ \ \\
%===============================================================================
...
%===============================================================================
\item[\fbox{\texttt{(AR-IApp)}}]\quad$\tenv \vturns \rulet_2 \leadsto E_2\,E_1$ \ \\
%===============================================================================
...
The key case is the one for rule \mylabel{AR-IVar} where $\rulet' = \rulet$ and
...
%===============================================================================
  From the first assumption of rule \mylabel{R-IAbs} and the induction hypothesis, we have
\begin{equation*}
  \tenv, x : \rulet_1 \vturns \rulet_2 \leadsto E
\end{equation*}

  Hence, from rule \mylabel{AR-IAbs} and the freshness condition on $x$ in
rule \mylabel{R-IAbs} it follows that
\begin{equation*}
...
%===============================================================================
  From the precondition of rule \mylabel{R-TAbs} and the induction hypothesis, we have
\begin{equation*}
  \tenv,\alpha \vturns \rulet \leadsto E
\end{equation*}

  Hence, from rule \mylabel{AR-TAbs} it follows that
\begin{equation*}
...
\end{equation*}
  ...
  $(\rulet \leadsto x) \in \tenv$. Hence, by rule \mylabel{AR-Simp} we have
\begin{equation*}
...
\end{equation*}
  From rule \mylabel{AR-IVar} we can also conclude
\begin{equation*}
  \tenv, \rulet_1 \leadsto x \vturns \rulet_1 \leadsto x
\end{equation*}
  These two facts allow us to derive from rule \mylabel{AR-IApp}
\begin{equation*}
...
\end{equation*}
  This allows us to conclude by rule \mylabel{AR-TApp} that
\begin{equation*}
...
%===============================================================================
  ...
  hypothesis is also construted with rule \mylabel{L-RuleMatch}.
