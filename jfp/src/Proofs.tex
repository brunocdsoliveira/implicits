...
judgment.
%depends on the auxiliary lemma that the type-unambiguity judgment is preserved under type
%substitution.
The dependencies of the proofs of this section are depicted in the diagram below.
\begin{center}
