...
$\theta(\type') = \theta(\type)$. Hence, with rule~\rref{M-Simp}, we obtain the goal judgment.
\begin{equation*}
...
\end{equation*}
where $\Sigma' = \theta(\Sigma,\ie{\rulet_1}{x}),\Sigma''$. By rule \rref{M-IApp} we may then conclude
\begin{equation*}
