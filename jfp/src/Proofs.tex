...
an auxiliary judgment for the correctness of the unification algorithm is necessary.
...
From Lemma~\ref{lemma:acompleteness:5} and rule \rref{Alg-M-Simp} we then have
\begin{equation*}
