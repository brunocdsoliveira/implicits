...
\end{equation*}
  then
\begin{equation*}
  \forall \Sigma, \exists \theta', \quad \admres{\bar\alpha}{\tenv}{\rulet}{E}{\Sigma}{\type}{E'}{\theta'(\Sigma),\Sigma'}
\end{equation*}
\end{lemma}
\end{minipage}
}}
...
By Lemma~\ref{lemma:acompleteness:5} \tom{should be new lemma} applied on the second hypothesis of the theorem
and the side condition that $\type = \theta(\type')$, we get
\begin{equation*}
  \theta = \mgu{\type}{\type'}
\end{equation*}
...
\end{eqnarray*}
In addition, since $\alpha$ does not appear free in $\etrans{\theta}(E)$,
...
\fbox{
\begin{minipage}{0.95\columnwidth}
\begin{axiom}\label{axiom:acompleteness:5}
  If 
\begin{equation*}
  \theta(\type) = \theta(\type')
\end{equation*}
...
\fbox{
\begin{minipage}{0.95\columnwidth}
\begin{axiom}\label{axiom:acompleteness:8}
  If 
\begin{equation*}
  \theta(\type) = \type'
\end{equation*}
