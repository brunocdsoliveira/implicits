...
\begin{equation*}
\drres{\bar{\alpha},\bar{\alpha}'}{\tenv,(\tenv',\ie{\rulet_1}{x})[\suty/\alpha]}{\rulet_2[\suty/\alpha]}{E[\etrans{\suty}/\alpha]}
...
\begin{equation*}
\drres{\bar{\alpha},\bar{\alpha}'}{\tenv,\tenv'[\suty/\alpha]}{(\rulet_1 \iarrow \rulet_2)[\suty/\alpha]}{(\abs{\relation{x}{\etrans{\rulet_1}}}{E})[\etrans{\suty}/\alpha]}
...
\begin{equation*}
\drres{\bar{\alpha},\bar{\alpha}'}{\tenv,\tenv'[\suty/\alpha]}{(\tall{\beta}{\rulet})[\suty/\alpha]}{(\Abs{\beta}{E})[\etrans{\suty}/\alpha]}
...
\begin{equation*}
\dlres{\bar{\alpha},\bar{\alpha}'}{\tenv,\tenv'[\suty/\alpha]}{\tenv'''}{\type[\suty/\alpha]}{E[\etrans{\suty}/\alpha]}
...
\begin{equation*}
\dlres{\bar{\alpha},\bar{\alpha}'}{\tenv,\tenv'[\suty/\alpha]}{\tenv,\tenv'[\suty/\alpha]}{\type[\suty/\alpha]}{E[\etrans{\suty}/\alpha]}
...
\begin{equation*}
\drres{\bar{\alpha},\bar{\alpha}'}{\tenv,\tenv'[\suty/\alpha]}{\type[\suty/\alpha]}{E[\etrans{\suty}/\alpha]}
