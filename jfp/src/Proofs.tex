...
\dnode{UAC}{right=of AM}{lemma:mgu_property:1}{Unification algorithm unifies}
%edges
...
\dnode{MIS}{below=of AM}{axiom:mgu_property:2}{Unification algorithm produces most general unifier}
%edges
...
By Lemma~\ref{lemma:mgu_property:2} \tom{should be new lemma} applied on the second hypothesis of the theorem
