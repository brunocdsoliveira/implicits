...
corresponding judgments. Interestingly, the algorithmic lookup judgment also uses completeness
of the algorithmic matching judgment. Two additional auxiliary lemmata are required for the
algorithmic lookup and matching soundness.
...
\dnode{AF}{below=of AR}{lemma:asoundness:1}{Algorithmic focusing is sound wrt to det. focusing}
\dnode{AL}{right=of AF}{lemma:asoundness:2}{Algorithmic lookup is sound wrt to det. lookup}
\dnode{AM}{above=of AL}{lemma:asoundness:3}{Algorithmic matching is sound wrt to det. matching}
\dnode{AMC}{below=of AL}{lemma:acompleteness:3}{Algorithmic matching is complete wrt to det. matching}
...
\dnode{AF}{right=0.8cm of AR}{lemma:acompleteness:1}{Algorithmic focusing is complete wrt to det. focusing}
\dnode{AL}{right=0.8cm of AF}{lemma:acompleteness:2}{Algorithmic lookup is complete wrt to det. lookup}
\dnode{AM}{right=0.8cm of AL}{lemma:acompleteness:3}{Algorithmic matching is complete wrt to det. matching}
\dnode{AMC}{below=of AL}{lemma:asoundness:3}{Algorithmic matching is sound wrt to det. matching}
