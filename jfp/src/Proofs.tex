...
\begin{lemma}\label{lemma:acompleteness:3}
  If 
\begin{equation*}
\dmres{\theta_1(\tenv)}{\theta_1(\rulet)}{\etrans{\theta_1}(E)}{\theta_1(\type)}{\etrans{\theta_1}(E')}{\theta_1(\Sigma')}
\end{equation*}
  and
\begin{equation*}
...
\begin{equation*}
  \dmres{\theta_1(\tenv)}{\theta_1(\rulet)[\suty/\alpha]}{\etrans{\theta_1}(\mmapp{E}{\etrans{\suty}})}{\theta_1(\Sigma')}{\theta_1(\type)}{\etrans{\theta_1}(E')}
\end{equation*}
