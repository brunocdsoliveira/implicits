...
$\admress{\bar\alpha}{\tenv}{\rulet_1\To\rulet_2}{E}{\Sigma}{\type}{E'}{\Sigma', \theta(\Sigma)}{\theta}$\ \\
%$\bar{\alpha}; \tenv; \rulet_1 \iarrow \rulet_2~{\leadsto E}; \Sigma \alg \type~{\leadsto E'}; \Sigma',\theta(\rulet_1) \leadsto x, \theta(\Sigma);\theta$ \ \\
%===============================================================================
  From the hypothesis of the rule, the induction hypothesis and the definition of substitution,
we have that
\begin{equation*}
...
\begin{equation*}
\forall \Sigma'',~\admres{\bar\alpha}{\tenv,\envi{\rulet_1}{x}}{\rulet_2}{\mmapp{E}{x}}{\Sigma'',\ie{\rulet_1}{x}}{\type}{\etrans{\theta_2}(E')}{\theta_2(\Sigma',\Sigma'',\ie{\rulet_1}{x})}
\end{equation*}

  By rule \rref{Alg-M-IApp} we may then conclude
\begin{equation*}
\forall\Sigma'',~\admres{\bar\alpha}{\tenv}{\rulet_1\To\rulet_2}{E}{\Sigma''}{\type}{\etrans{\theta_2}(E')}{\theta_2(\Sigma',\Sigma'',\ie{\rulet_1}{x})}
