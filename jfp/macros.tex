...
\newcommand{\myrule}[3]{\inferrule*[left={\scriptsize\mylabel{#1}}]{#2}{#3}}
...
\newcommand{\fturns}{\vdash^f_{r}}
\newcommand{\vturns}{\vdash^a_{r}}
\newcommand{\ivturns}{\mathop{\turns_{r}}}
